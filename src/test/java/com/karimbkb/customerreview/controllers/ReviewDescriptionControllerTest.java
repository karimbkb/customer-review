...
public class ReviewDescriptionControllerTest {
    ...
    @Test
    void shouldNotGetReviewDescriptionWithException() throws Exception {
        // when
        when(reviewDescriptionRepository.findById(REVIEW_DESCRIPTION_ID)).thenReturn(Optional.empty());
